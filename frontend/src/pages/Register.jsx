    ...
    <div style={{ minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:20,background:"#f4f4f5" }}>
      <div style={{ width:"100%",maxWidth:400 }}>
        <div className="card" style={{ padding:32,textAlign:"center" }}>
          ...
          <p style={{ fontSize:14,color:"var(--muted)",lineHeight:1.7,marginBottom:8 }}>Link pengesahan dihantar ke:</p>
          <div style={{ background:"var(--muted-bg)",borderRadius:8,padding:"10px 16px",marginBottom:20,fontWeight:700,fontSize:15 }}>{doneEmail}</div>
          <div style={{ background:"var(--green-bg)",borderRadius:10,padding:"12px 16px",marginBottom:20,border:"1px solid var(--green-border)" }}>
            <p style={{ fontSize:13,color:"var(--green-dark)",margin:0,lineHeight:1.6 }}>
              ...
              📁 Semak juga folder <strong>Spam</strong> atau <strong>Promosi</strong>.
            </p>
          </div>
          <Link to="/login" style={{ display:"block",textDecoration:"none" }}>
            <button className="btn btn-default btn-lg" style={{ width:"100%" }}>Kembali ke Login →</button>
          </Link>
        </div>
      </div>
    </div>
      ...
      <div style={{ width:"100%",maxWidth:400 }}>
        ...
        <div className="card" style={{ padding:28 }}>
          ...
          <p style={{ fontSize:12,color:"var(--muted)",textAlign:"center",marginTop:14,lineHeight:1.6 }}>
            Dengan mendaftar, anda bersetuju dengan <span style={{ color:"var(--green-dark)",fontWeight:500 }}>Terma Perkhidmatan</span> kami.
          </p>
