  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (data.requiresVerification) {
        setDoneEmail(form.email); setDone(true);
      } else {
        handleSuccess(data);
      }
      ...
      <div style={{ width:"100%", maxWidth:400 }}>
        <div className="card" style={{ padding:32, textAlign:"center" }}>
          ...
          <p style={{ fontSize:14, color:"var(--muted)", lineHeight:1.7, marginBottom:8 }}>
            Link pengesahan telah dihantar ke:
          </p>
          <div style={{ background:"var(--muted-bg)", borderRadius:8, padding:"10px 16px", marginBottom:20, fontWeight:700, fontSize:15 }}>
            {doneEmail}
          </div>
          ...
          <Link to="/login" style={{ display:"block", textDecoration:"none" }}>
            <button className="btn btn-default btn-lg" style={{ width:"100%" }}>
              Kembali ke Login →
            </button>
          </Link>
        </div>
      ...
      <div style={{ width:"100%", maxWidth:400 }}>
        ...
        <div className="card" style={{ padding:28 }}>
          ...
          <p style={{ fontSize:12, color:"var(--muted)", textAlign:"center", marginTop:14, lineHeight:1.6 }}>
            ...
            <span style={{ color:"var(--green-dark)", fontWeight:500 }}>Terma Perkhidmatan</span> kami.
          </p>
